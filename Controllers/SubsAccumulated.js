    ...
    .then(data1 => {
        ...
        .then(async data2 => {
            ...
            .then(async data => {
                ...
                await Communityactivity.findByIdAndUpdate(process.env.tradepayin, {$inc: {amount: tradepayin}})
                await Communityactivity.findByIdAndUpdate(process.env.complanpayin, {$inc: {amount: complan}})
